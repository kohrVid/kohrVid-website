  ...
  describe "POST create" do
    ...
    context "with valid attributes" do
      it "creates a new user" do
        expect{
          post :create, user: FactoryBot.attributes_for(:user, :reader)
    ...
    context "with invalid attributes" do
      it "doesn't save the new user" do
        expect{
          post :create, user: FactoryBot.attributes_for(:user, :reader, name: "")
  ...
  describe "PUT update" do
    ...
    context "with valid attributes" do
      it "locates the requested @user" do
        put :update, id: @user.id, user: FactoryBot.attributes_for(:user, :reader)
        expect(assigns(:user)).to eq(user)
      end

      it "changes @user's attributes" do
        put :update, id: @user.id, user: FactoryBot.attributes_for(:user, :reader, name: "Services", bio: "These are the services we provide.")
        user.reload
    ...
    context "with invalid attributes" do
      it "shouldn't change @user's attributes" do
        put :update, id: @user.id, user: FactoryBot.attributes_for(:user, :reader, name: "", bio: "r")
        @user.reload
      ...
      it "renders the edit user" do
        put :update, id: @user.id, user: FactoryBot.attributes_for(:user, :reader, name: "", bio: "Raine is from Cote d'Ivoire")
